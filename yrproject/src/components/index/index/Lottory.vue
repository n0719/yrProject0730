  ...
  <div class="lottoryBox">
    ...
    <div class="container">
      ...
      <el-row class="middleBox" type="flex" justify="space-between">
        <el-col :span="11" v-for="item in list.child" :key="item.game_line_id" class="itemGame">
...
.lottoryBox .itemGame:hover .itemTitle,.lottoryBox .itemGame:hover:before{
    opacity: 1;
}
</style>